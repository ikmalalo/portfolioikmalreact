...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.0235, 0.7137, 0.8314); // #06B6D4
    const vec3 baseColor2 = vec3(0.0, 1.0, 0.9686);     // #00fff7
    const vec3 baseColor3 = vec3(0.0, 0.2941, 0.2863);  // #004b49
  ...
  useEffect(() => {
    ...
    const update = t => {
      ...
      lastTime = t;
      const { hue, hoverIntensity, rotateOnHover, forceHoverState, backgroundColor } = propsRef.current;
