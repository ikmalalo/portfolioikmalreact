...
const ProfileCardComponent = ({
  ...
  const tiltEngine = useMemo(() => {
    ...
    const setVarsFromXY = (x, y) => {
      ...
      // Simplify: only update essential variables frequently
      ...
      // Calculate background and center offset less often or more simply
      wrap.style.setProperty('--background-x', `${35 + (px * 0.3)}%`);
      wrap.style.setProperty('--background-y', `${35 + (py * 0.3)}%`);
